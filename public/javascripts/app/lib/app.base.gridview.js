...
Ext.app.base.GridView = Ext.extend(Ext.grid.GridPanel, {
  dataRecordMeta               : null,
  recordPk                     : new Array(),
  ...
  initComponent                : function() {
    ...
    Ext.app.base.GridView.superclass.initComponent.apply(this, arguments);
    this.addEvents('executeQuerySuccess');
    this.addEvents('createNewRecord');
  },

  initEvents                   : function() {
    Ext.app.base.GridView.superclass.initEvents.call(this);
...
Ext.reg('AppGridView', Ext.app.base.GridView);