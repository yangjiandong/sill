...
Ext.app.base.Combo = Ext.extend(Ext.form.ComboBox, {
  ...
  ,initComponent:function() {
     ...
     Ext.app.base.Combo.superclass.initComponent.apply(this, arguments);
  ...
  ,initEvents: function() {
    Ext.app.base.Combo.superclass.initEvents.call(this);
 ...
 ,onSelectValue: function (cbo, rec, idx ) {
  ...
  ,onFocus: function () {
    ...
    if (!this.isStoreLoaded) {
      ...
      //Ext.app.base.Combo.superclass.onFocus.apply(this, arguments);
      //return false;
    } else {
      Ext.app.base.Combo.superclass.onFocus.apply(this, arguments);
    }
  ...
  ,onBlur: function () {
    ...
    Ext.app.base.Combo.superclass.onBlur.apply(this, arguments);
  }
  ...
  ,onTriggerClick:function() {
     ...
     Ext.app.base.Combo.superclass.onTriggerClick.apply(this, arguments);
  }
...
Ext.reg('AppCombo', Ext.app.base.Combo);