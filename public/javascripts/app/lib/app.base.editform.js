...
Ext.app.base.EditForm = Ext.extend(Ext.form.FormPanel, {
   dataRecord: null
  ,sysName:''//模块名
  ...
  ,initComponent:function() {
     ...
     Ext.app.base.EditForm.superclass.initComponent.apply(this, arguments);
 ...
 ,initEvents: function() {
    Ext.app.base.EditForm.superclass.initEvents.call(this);
...
// --------------------------- commitForm ----------------------
 ...
 Ext.reg('AppEditForm', Ext.app.base.EditForm);