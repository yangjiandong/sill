...
Ext.extend(MainPanel, Ext.TabPanel, {
  ...
  initSearch : function() {
    ...
    var resultTpl = new Ext.XTemplate(
        ...
        '<img src="javascripts/ext/resources/images/default/s.gif" class="item-icon icon-{type}"/>{member}',
        '</a> ',
...
Ext.extend(Ext.ux.SelectBox, Ext.form.ComboBox, {
      ...
      selectNextPage : function() {
        ...
        var index = Math.min(this.selectedIndex + this.rowsPerPage, this.store
                .getCount()
                - 1);
        this.focusAndSelect(this.store.getAt(index));
      },
